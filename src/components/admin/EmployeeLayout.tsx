...
export default function EmployeeLayout() {
  ...
  const links = [
    {
      ...
      description: "Overview & My Tasks",
    },
    {
      label: "My Tasks",
      path: "/user/employee/task",
      icon: CheckSquare,
  ...
  const getFullName = () => {
    if (userData) {
      return `${userData.first_name || ""} ${userData.last_name || ""}`.trim() || "Employee";
    }
    return "Employee";
  };
  ...
  const getUserEmail = () => {
    if (userData) {
      return userData.email || "employee@example.com";
    }
    ...
    <div className="min-h-screen flex bg-gray-900">
      ...
      >
        ...
        <nav className="p-4 space-y-1 flex-1 overflow-y-auto">
          {links.map((l) => {
            ...
            return (
              ...
              >
                <l.icon className={`w-5 h-5 ${active ? "text-white" : "text-gray-500 group-hover:text-gray-300"}`} />
                <div className="flex-1 min-w-0">
        ...
        <div className="p-4 border-t border-gray-700 mt-auto">
          <div className="mb-3 p-3 rounded-xl bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-500/20">
        ...
        <header className="sticky top-0 z-30 bg-gray-800/80 backdrop-blur-sm shadow-lg px-4 md:px-6 py-4 flex items-center gap-4 border-b border-gray-700">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-400">
              {links.find((l) => l.label === currentPage)?.description || "Manage your tasks"}
            </p>
          </div>
                ...
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-64 bg-gray-800 rounded-xl shadow-2xl border border-gray-700 py-2 z-50">
                    ...
                    <div className="px-4 py-3 border-b border-gray-700">
                      ...
                      <div className="mt-2">
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-blue-500/20 text-blue-400 text-xs">
