    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-white">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading task management dashboard...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <CheckSquare className="relative w-8 h-8 text-blue-600" />
              </div>
              <div>
                  ...
                  <div className="p-3 rounded-xl bg-gray-50 border border-gray-200">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {allUsers.slice(0, 5).map((member) => (
                        <div
                          key={member._id}
                          className="flex items-center gap-1 px-2 py-1 rounded-full bg-gray-200 border border-gray-300"
                        >
